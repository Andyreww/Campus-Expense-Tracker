...
async function main() {
    try {
        ...
        console.error("Fatal Error initializing questionnaire page:", error);
        const errorMessageEl = document.getElementById('questionnaire-error');
        if(errorMessageEl) {
            errorMessageEl.textContent = "Could not connect to services. Please check your connection and try again.";
